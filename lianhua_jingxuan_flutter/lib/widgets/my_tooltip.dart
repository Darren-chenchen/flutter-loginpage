...
class _MyTooltipState extends State<MyTooltip> with SingleTickerProviderStateMixin {
  ...
  void _hideTooltip({ bool immediately = false }) {
    ...
    if (_longPressActivated || _tapPressActivated) {
  ...
  void _handleLongPress() {
    ...
    if (tooltipCreated)
      MyFeedback.forLongPress(context);
  }

  _handleTapPress() {
    _tapPressActivated = true;
    final bool tooltipCreated = ensureTooltipVisible();
    if (tooltipCreated)
      MyFeedback.forTap(context);
  }
                  ...
                  child: Stack(
                    ...
                    children: <Widget>[
                      ...
                      Positioned(
                        left: 46,
                        top: 19,
                        child: Icon(Icons.arrow_drop_down, size: 30,color: Colors.grey[700].withOpacity(0.9),),
                      )
                    ],
                  ),
                ),
