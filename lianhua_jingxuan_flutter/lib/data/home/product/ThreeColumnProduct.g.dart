...
part of 'ThreeColumnProduct.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ThreeColumnProduct _$ThreeColumnProductFromJson(Map<String, dynamic> json) {
  return ThreeColumnProduct(
...
Map<String, dynamic> _$ThreeColumnProductToJson(ThreeColumnProduct instance) =>
    <String, dynamic>{
      'id': instance.id,
      'type': instance.type,
      'name': instance.name,
