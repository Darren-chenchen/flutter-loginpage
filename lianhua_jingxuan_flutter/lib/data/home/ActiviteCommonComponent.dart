...
part 'ActiviteCommonComponent.g.dart';

@JsonSerializable()
class ActiviteCommonComponent extends StrandComponent{
  //标题名称
  String title;
  //展示颜色
  String titleColor;
  ...
  factory ActiviteCommonComponent.fromJson(Map<String, dynamic> json) => _$ActiviteCommonComponentFromJson(json);

  Map<String, dynamic> toJson() => _$ActiviteCommonComponentToJson(this);
