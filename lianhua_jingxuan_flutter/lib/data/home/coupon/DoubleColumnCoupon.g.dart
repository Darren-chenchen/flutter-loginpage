...
part of 'DoubleColumnCoupon.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DoubleColumnCoupon _$DoubleColumnCouponFromJson(Map<String, dynamic> json) {
  return DoubleColumnCoupon(
...
Map<String, dynamic> _$DoubleColumnCouponToJson(DoubleColumnCoupon instance) =>
    <String, dynamic>{
      'id': instance.id,
      'type': instance.type,
      'name': instance.name,
