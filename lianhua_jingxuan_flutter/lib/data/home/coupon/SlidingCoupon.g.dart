...
part of 'SlidingCoupon.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SlidingCoupon _$SlidingCouponFromJson(Map<String, dynamic> json) {
  return SlidingCoupon(
...
Map<String, dynamic> _$SlidingCouponToJson(SlidingCoupon instance) =>
    <String, dynamic>{
      'id': instance.id,
      'type': instance.type,
      'name': instance.name,
